...
When the compiler can prove the removal statically, Yogi reports the same class
of bug during semantic analysis before LLVM is generated:
...
users.pop()
age = 99 // semantic error: pointer target slot was removed by pop
```
