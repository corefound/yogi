...
namespace yogi::runtime {
    ...
    void MemoryManager::popMemoryContext(const char* exitReason) {
        MemoryTelemetry::popContext(exitReason);
    }
...
extern "C" {
    ...
    void* yogi_realloc(void* address, unsigned long long newSize) {
        return yogi::runtime::MemoryManager::reallocate(address, static_cast<std::size_t>(newSize), "raw reallocation");
    }
    ...
    void yogi_memory_pop_context_with_reason(const char* exitReason) {
        yogi::runtime::MemoryManager::popMemoryContext(exitReason);
    }
    ...
    unsigned long long yogi_memory_attributed_live_bytes(const char* moduleName, const char* functionName) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedLiveBytes(moduleName, functionName));
    }

    unsigned long long yogi_memory_attributed_live_allocations(const char* moduleName, const char* functionName) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedLiveAllocations(moduleName, functionName));
    }

    unsigned long long yogi_memory_attributed_total_allocated_bytes(const char* moduleName, const char* functionName) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedTotalAllocatedBytes(moduleName, functionName));
    }

    unsigned long long yogi_memory_attributed_total_freed_bytes(const char* moduleName, const char* functionName) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedTotalFreedBytes(moduleName, functionName));
    }

    unsigned long long yogi_memory_attributed_peak_bytes(const char* moduleName, const char* functionName) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedPeakBytes(moduleName, functionName));
    }

    void yogi_memory_push_source_location(const char* sourcePath, unsigned long long line, unsigned long long column) {
        yogi::runtime::MemoryManager::pushMemorySourceLocation(sourcePath, static_cast<std::size_t>(line), static_cast<std::size_t>(column));
    }
    ...
    unsigned long long yogi_memory_attributed_location_live_bytes(const char* sourcePath, unsigned long long line, unsigned long long column) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedLocationLiveBytes(sourcePath, static_cast<std::size_t>(line), static_cast<std::size_t>(column)));
    }
    ...
    unsigned long long yogi_memory_attributed_location_live_allocations(const char* sourcePath, unsigned long long line, unsigned long long column) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedLocationLiveAllocations(sourcePath, static_cast<std::size_t>(line), static_cast<std::size_t>(column)));
    }
    ...
    unsigned long long yogi_memory_attributed_location_total_allocated_bytes(const char* sourcePath, unsigned long long line, unsigned long long column) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedLocationTotalAllocatedBytes(sourcePath, static_cast<std::size_t>(line), static_cast<std::size_t>(column)));
    }
    ...
    unsigned long long yogi_memory_attributed_location_total_freed_bytes(const char* sourcePath, unsigned long long line, unsigned long long column) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedLocationTotalFreedBytes(sourcePath, static_cast<std::size_t>(line), static_cast<std::size_t>(column)));
    }
    ...
    unsigned long long yogi_memory_attributed_location_peak_bytes(const char* sourcePath, unsigned long long line, unsigned long long column) {
        return static_cast<unsigned long long>(yogi::runtime::MemoryManager::attributedLocationPeakBytes(sourcePath, static_cast<std::size_t>(line), static_cast<std::size_t>(column)));
    }
