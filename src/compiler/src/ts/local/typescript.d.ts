...
declare namespace ts {
    ...
    enum SyntaxKind {
        ...
        StructFieldDeclaration = 268,
        StructFunctionDeclaration = 269,
        InterfaceDeclaration = 270,
        TypeAliasDeclaration = 271,
        EnumDeclaration = 272,
        ModuleDeclaration = 273,
        ExternDeclaration = 274,
        ModuleBlock = 275,
        CaseBlock = 276,
    ...
    type DeclarationWithTypeParameterChildren = SignatureDeclaration | ClassLikeDeclaration | StructDeclaration | InterfaceDeclaration | TypeAliasDeclaration | JSDocTemplateTag;
    ...
    interface StructDeclaration extends DeclarationStatement, JSDocContainer {
    ...
    interface ExternDeclaration extends DeclarationStatement, JSDocContainer {
    ...
    type ExternElement = TypeElement | Statement;
    ...
    function isStructMember(node: Node): node is StructMember;
    ...
    function isStructFieldDeclaration(node: Node): node is StructFieldDeclaration;
    function isStructFunctionDeclaration(node: Node): node is StructFunctionDeclaration;
    function isInterfaceDeclaration(node: Node): node is InterfaceDeclaration;
    function isTypeAliasDeclaration(node: Node): node is TypeAliasDeclaration;
    function isEnumDeclaration(node: Node): node is EnumDeclaration;
    function isModuleDeclaration(node: Node): node is ModuleDeclaration;
    function isExternDeclaration(node: Node): node is ExternDeclaration;
