...
export class AssignmentExpression {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AssignmentExpression {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAssignmentExpression(bb:flatbuffers.ByteBuffer, obj?:AssignmentExpression):AssignmentExpression {
  return (obj || new AssignmentExpression()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAssignmentExpression(bb:flatbuffers.ByteBuffer, obj?:AssignmentExpression):AssignmentExpression {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new AssignmentExpression()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

left(obj?:IdentifierExpression):IdentifierExpression|null {
...
static startAssignmentExpression(builder:flatbuffers.Builder) {
...
static endAssignmentExpression(builder:flatbuffers.Builder):flatbuffers.Offset {
