...
export class DereferenceExpression {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DereferenceExpression {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDereferenceExpression(bb:flatbuffers.ByteBuffer, obj?:DereferenceExpression):DereferenceExpression {
  return (obj || new DereferenceExpression()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDereferenceExpression(bb:flatbuffers.ByteBuffer, obj?:DereferenceExpression):DereferenceExpression {
...
static startDereferenceExpression(builder:flatbuffers.Builder) {
...
static endDereferenceExpression(builder:flatbuffers.Builder):flatbuffers.Offset {
