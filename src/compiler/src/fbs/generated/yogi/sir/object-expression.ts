...
import { ObjectProperty } from '../../yogi/sir/object-property.js';
...
export class ObjectExpression {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ObjectExpression {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsObjectExpression(bb:flatbuffers.ByteBuffer, obj?:ObjectExpression):ObjectExpression {
  return (obj || new ObjectExpression()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsObjectExpression(bb:flatbuffers.ByteBuffer, obj?:ObjectExpression):ObjectExpression {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new ObjectExpression()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

properties(index: number, obj?:ObjectProperty):ObjectProperty|null {
  const offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? (obj || new ObjectProperty()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static startObjectExpression(builder:flatbuffers.Builder) {
...
static endObjectExpression(builder:flatbuffers.Builder):flatbuffers.Offset {
