...
export class AddressOfExpression {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AddressOfExpression {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAddressOfExpression(bb:flatbuffers.ByteBuffer, obj?:AddressOfExpression):AddressOfExpression {
  return (obj || new AddressOfExpression()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAddressOfExpression(bb:flatbuffers.ByteBuffer, obj?:AddressOfExpression):AddressOfExpression {
