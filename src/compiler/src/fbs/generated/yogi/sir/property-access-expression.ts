...
export class PropertyAccessExpression {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PropertyAccessExpression {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPropertyAccessExpression(bb:flatbuffers.ByteBuffer, obj?:PropertyAccessExpression):PropertyAccessExpression {
  return (obj || new PropertyAccessExpression()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPropertyAccessExpression(bb:flatbuffers.ByteBuffer, obj?:PropertyAccessExpression):PropertyAccessExpression {
...
static startPropertyAccessExpression(builder:flatbuffers.Builder) {
...
static endPropertyAccessExpression(builder:flatbuffers.Builder):flatbuffers.Offset {
