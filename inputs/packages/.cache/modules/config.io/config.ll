...
@0 = private unnamed_addr constant [10 x i8] c"config_io\00", align 1
@1 = private unnamed_addr constant [13 x i8] c"$module.init\00", align 1
@2 = private unnamed_addr constant [10 x i8] c"config.io\00", align 1
@3 = private unnamed_addr constant [10 x i8] c"config.io\00", align 1
@4 = private unnamed_addr constant [10 x i8] c"config.io\00", align 1
@5 = private unnamed_addr constant [10 x i8] c"config_io\00", align 1
...
entry:
  ...
  call void @yogi_memory_push_source_location(ptr @2, i64 1, i64 14)
  call void @yogi_memory_pop_source_location()
  store double 1.000000e+02, ptr @_yogi_config_io_maxScore, align 8
  call void @yogi_memory_push_source_location(ptr @3, i64 2, i64 14)
  call void @yogi_memory_pop_source_location()
  store double 7.000000e+01, ptr @_yogi_config_io_minDeployScore, align 8
  call void @yogi_memory_push_source_location(ptr @4, i64 3, i64 14)
  call void @yogi_memory_pop_source_location()
