...
@11 = private unnamed_addr constant [8 x i8] c"main_io\00", align 1
@12 = private unnamed_addr constant [22 x i8] c"main.io:findThreshold\00", align 1
...
@17 = private unnamed_addr constant [8 x i8] c"main_io\00", align 1
@18 = private unnamed_addr constant [13 x i8] c"$module.init\00", align 1
@19 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
...
@24 = private unnamed_addr constant [9 x i8] c"platform\00", align 1
@25 = private unnamed_addr constant [13 x i8] c"release-team\00", align 1
@26 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@_yogi_scoring_io_hasEnoughScore = external global i1
@27 = private unnamed_addr constant [7 x i8] c"stable\00", align 1
@28 = private unnamed_addr constant [10 x i8] c"candidate\00", align 1
...
@32 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@33 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@34 = private unnamed_addr constant [8 x i8] c"retries\00", align 1
@35 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@36 = private unnamed_addr constant [5 x i8] c"name\00", align 1
...
@40 = private unnamed_addr constant [9 x i8] c"fallback\00", align 1
@41 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@42 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
...
@48 = private unnamed_addr constant [18 x i8] c"release-candidate\00", align 1
@49 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@50 = private unnamed_addr constant [16 x i8] c"automated-check\00", align 1
@51 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@52 = private unnamed_addr constant [14 x i8] c"manual-review\00", align 1
@53 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@54 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@55 = private unnamed_addr constant [8 x i8] c"main.io\00", align 1
@56 = private unnamed_addr constant [8 x i8] c"main_io\00", align 1
@57 = private unnamed_addr constant [16 x i8] c"$module.cleanup\00", align 1
...
entry:
  ...
  %yogi_array_at_index.call = call ptr @yogi_array_at_index(ptr %scores.load4, double 0.000000e+00)
  call void @yogi_memory_pop_source_location()
  store ptr %yogi_array_at_index.call, ptr %first, align 8
  call void @yogi_memory_push_source_location(ptr @10, i64 54, i64 5)
  %scores.load5 = load ptr, ptr %scores, align 8
  %yogi_array_length.call = call i64 @yogi_array_length(ptr %scores.load5)
  %array.length = uitofp i64 %yogi_array_length.call to double
  call void @yogi_memory_pop_source_location()
  call void @yogi_array_drop(ptr %scores.array.storage)
  call void @yogi_memory_pop_context()
  ret double %array.length
}
...
declare ptr @yogi_array_at_index(ptr, double)

declare i64 @yogi_array_length(ptr)
...
entry:
  ...
  call void @yogi_memory_push_context(ptr @11, ptr @12)
  store ptr %scores, ptr %scores1, align 8
  store double %threshold, ptr %threshold2, align 8
  call void @yogi_memory_push_source_location(ptr @13, i64 61, i64 9)
  call void @yogi_memory_pop_source_location()
  store double 0.000000e+00, ptr %result, align 8
  call void @yogi_memory_push_source_location(ptr @14, i64 63, i64 14)
  call void @yogi_memory_pop_source_location()
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %yogi_array_length.call = call i64 @yogi_array_length(ptr %scores.load)
  %array.length = uitofp i64 %yogi_array_length.call to double
  %cmptmp = fcmp olt double %i.load, %array.length
  br i1 %cmptmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  call void @yogi_memory_push_source_location(ptr @15, i64 64, i64 13)
  ...
  call void @yogi_memory_pop_source_location()
  store double %yogi_any_to_number.call, ptr %value, align 8
  %value.load = load double, ptr %value, align 8
  %threshold.load = load double, ptr %threshold2, align 8
  %cmptmp5 = fcmp ogt double %value.load, %threshold.load
  br i1 %cmptmp5, label %if.then, label %if.end

for.inc:                                          ; preds = %if.end9, %if.then8
  %i.load11 = load double, ptr %i, align 8
  %addtmp12 = fadd double %i.load11, 1.000000e+00
  store double %addtmp12, ptr %i, align 8
  br label %for.cond

for.end:                                          ; preds = %if.then, %for.cond
  call void @yogi_memory_push_source_location(ptr @16, i64 78, i64 5)
  %result.load13 = load double, ptr %result, align 8
  call void @yogi_memory_pop_source_location()
  call void @yogi_memory_pop_context()
  ret double %result.load13

if.then:                                          ; preds = %for.body
  %value.load6 = load double, ptr %value, align 8
  store double %value.load6, ptr %result, align 8
  br label %for.end

if.end:                                           ; preds = %for.body
  %value.load7 = load double, ptr %value, align 8
  %eqtmp = fcmp oeq double %value.load7, 0.000000e+00
  br i1 %eqtmp, label %if.then8, label %if.end9
...
if.end9:                                          ; preds = %if.end
  ...
  %value.load10 = load double, ptr %value, align 8
  %addtmp = fadd double %result.load, %value.load10
...
entry:
  ...
  call void @yogi_memory_push_context(ptr @17, ptr @18)
  call void @yogi_memory_push_source_location(ptr @19, i64 10, i64 5)
  call void @yogi_memory_pop_source_location()
  store double 0.000000e+00, ptr @_yogi_main_io_retryCount, align 8
  call void @yogi_memory_push_source_location(ptr @20, i64 11, i64 5)
  %yogi_any_from_number.call = call ptr @yogi_any_from_number(double 1.000000e+01)
  call void @yogi_memory_pop_source_location()
  store ptr %yogi_any_from_number.call, ptr @_yogi_main_io_externalPayload, align 8
  call void @yogi_memory_push_source_location(ptr @21, i64 12, i64 5)
  call void @yogi_memory_pop_source_location()
  store ptr null, ptr @_yogi_main_io_status, align 8
  call void @yogi_memory_push_source_location(ptr @22, i64 13, i64 5)
  call void @yogi_memory_pop_source_location()
  store ptr null, ptr @_yogi_main_io_cachedOwner, align 8
  call void @yogi_memory_push_source_location(ptr @23, i64 14, i64 5)
  call void @yogi_memory_pop_source_location()
  store ptr @24, ptr @_yogi_main_io_owner, align 8
  store ptr @25, ptr @_yogi_main_io_cachedOwner, align 8
  call void @yogi_memory_push_source_location(ptr @26, i64 17, i64 5)
...
cond.end:                                         ; preds = %cond.else, %cond.then
  %condtmp = phi ptr [ @27, %cond.then ], [ @28, %cond.else ]
  call void @yogi_memory_pop_source_location()
  store ptr %condtmp, ptr @_yogi_main_io_releaseName, align 8
  call void @yogi_memory_push_source_location(ptr @29, i64 18, i64 5)
  call void @yogi_memory_push_source_location(ptr @30, i64 18, i64 55)
  ...
  call void @yogi_object_set(ptr %yogi_object_create.call, ptr @31, ptr %yogi_any_from_string.call)
  call void @yogi_memory_pop_source_location()
  call void @yogi_memory_pop_source_location()
  ...
  call void @yogi_object_set(ptr %auditTarget.load, ptr @32, ptr %yogi_any_from_string.call1)
  call void @yogi_memory_push_source_location(ptr @33, i64 20, i64 5)
  %auditTarget.load2 = load ptr, ptr @_yogi_main_io_auditTarget, align 8
  %yogi_object_get.call = call ptr @yogi_object_get(ptr %auditTarget.load2, ptr @34)
  call void @yogi_memory_pop_source_location()
  store ptr %yogi_object_get.call, ptr @_yogi_main_io_targetRetries, align 8
  call void @yogi_memory_push_source_location(ptr @35, i64 21, i64 5)
  %auditTarget.load3 = load ptr, ptr @_yogi_main_io_auditTarget, align 8
  %yogi_object_get.call4 = call ptr @yogi_object_get(ptr %auditTarget.load3, ptr @36)
  ...
  call void @yogi_memory_push_source_location(ptr @37, i64 23, i64 7)
  call void @yogi_memory_push_source_location(ptr @38, i64 23, i64 48)
  %yogi_object_create.call5 = call ptr @yogi_object_create()
  call void @yogi_memory_pop_source_location()
  %yogi_object_get.call6 = call ptr @yogi_object_get(ptr %yogi_object_create.call5, ptr @39)
...
nullish.end:                                      ; preds = %nullish.fallback, %nullish.present
  %nullishtmp = phi ptr [ %yogi_any_to_string.call7, %nullish.present ], [ @40, %nullish.fallback ]
  call void @yogi_memory_pop_source_location()
  store ptr %nullishtmp, ptr @_yogi_main_io_name, align 8
  call void @yogi_memory_push_source_location(ptr @41, i64 24, i64 6)
  call void @yogi_memory_push_source_location(ptr @42, i64 24, i64 44)
...
nullish.end12:                                    ; preds = %nullish.fallback11, %nullish.present10
  ...
  call void @yogi_memory_push_source_location(ptr @43, i64 25, i64 5)
  call void @yogi_memory_push_source_location(ptr @44, i64 25, i64 28)
  ...
  call void @yogi_memory_push_source_location(ptr @45, i64 27, i64 5)
  ...
  call void @yogi_memory_push_source_location(ptr @46, i64 29, i64 5)
  ...
  call void @yogi_memory_push_source_location(ptr @47, i64 30, i64 5)
...
if.then:                                          ; preds = %nullish.end12
  store ptr @48, ptr @_yogi_main_io_status, align 8
  ...
  call void @yogi_memory_push_source_location(ptr @49, i64 36, i64 9)
  call void @yogi_memory_pop_source_location()
  store ptr @50, ptr %auditLabel, align 8
...
if.then25:                                        ; preds = %if.then
  call void @yogi_memory_push_source_location(ptr @51, i64 39, i64 13)
  call void @yogi_memory_pop_source_location()
...
if.then28:                                        ; preds = %if.end
  store ptr @52, ptr @_yogi_main_io_status, align 8
...
if.end29:                                         ; preds = %if.then28, %if.end
  call void @yogi_memory_push_source_location(ptr @53, i64 57, i64 5)
  ...
  call void @yogi_memory_push_source_location(ptr @54, i64 81, i64 5)
  call void @yogi_memory_push_source_location(ptr @55, i64 81, i64 45)
...
entry:
  call void @yogi_memory_push_context(ptr @56, ptr @57)
