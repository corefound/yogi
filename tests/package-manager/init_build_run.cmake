...
set(CYAN "${ESC}[96m")
set(YELLOW "${ESC}[93m")
set(printed_scores "${CYAN}[${RESET}${YELLOW}7${RESET}, ${YELLOW}8${RESET}, ${YELLOW}9${RESET}${CYAN}]${RESET}")
string(FIND "${run_stdout}" "${printed_scores}" printed_scores_index)
if(printed_scores_index EQUAL -1)
