...
entry:
  store double 4.800000e+01, double* @_yogi_metrics_io_rawScore, align 8
  store double 2.400000e+01, double* @_yogi_metrics_io_testCoverage, align 8
  store double 6.000000e+00, double* @_yogi_metrics_io_crashPenalty, align 8
  ret void
}
