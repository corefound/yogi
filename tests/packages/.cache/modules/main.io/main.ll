...
@5 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@6 = private unnamed_addr constant [8 x i8] c"retries\00", align 1
@7 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@8 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@9 = private unnamed_addr constant [9 x i8] c"fallback\00", align 1
@_yogi_config_io_maxRetries = external global double
@10 = private unnamed_addr constant [18 x i8] c"release-candidate\00", align 1
@11 = private unnamed_addr constant [16 x i8] c"automated-check\00", align 1
@12 = private unnamed_addr constant [14 x i8] c"manual-review\00", align 1
...
cond.end:                                         ; preds = %cond.else, %cond.then
  ...
  call void @yogi_object_set(ptr %yogi_object_create.call, ptr @4, ptr %yogi_any_from_string.call)
  ...
  call void @yogi_object_set(ptr %auditTarget.load, ptr @5, ptr %yogi_any_from_string.call1)
  %auditTarget.load2 = load ptr, ptr @_yogi_main_io_auditTarget, align 8
  %yogi_object_get.call = call ptr @yogi_object_get(ptr %auditTarget.load2, ptr @6)
  ...
  %yogi_object_get.call4 = call ptr @yogi_object_get(ptr %auditTarget.load3, ptr @7)
  ...
  %yogi_object_get.call6 = call ptr @yogi_object_get(ptr %yogi_object_create.call5, ptr @8)
...
nullish.end:                                      ; preds = %nullish.fallback, %nullish.present
  %nullishtmp = phi ptr [ %yogi_any_to_string.call7, %nullish.present ], [ @9, %nullish.fallback ]
...
if.then:                                          ; preds = %nullish.end12
  store ptr @10, ptr @_yogi_main_io_status, align 8
  ...
  store ptr @11, ptr %auditLabel, align 8
...
if.then28:                                        ; preds = %if.end
  store ptr @12, ptr @_yogi_main_io_status, align 8
